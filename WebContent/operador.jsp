        ...
        <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
            <div class="nano">
                <div class="nano-content">
                    <div class="logo"><a href="login.jsp"><!-- <img src="assets/images/logo.png" alt="" /> --><span>WebTicket</span></a></div>
                    <ul>
                        ...
                        <li class="active"><a class="sidebar-sub-toggle"><i class="ti-home"></i> Dashboard <span class="badge badge-primary">2</span> <span class="sidebar-collapse-icon ti-angle-down"></span></a>
                            <ul>
                                <li><a href="index.html">Operador</a></li>
                                <li><a href="index1.html">Cliente</a></li>
