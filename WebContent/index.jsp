				...
				<div class="col-lg-3">
					<div class="login-content">
						<div class="login-logo">
							<a href="WEB-INF/pages/administrador.jsp"><span><font
									style="vertical-align: inherit;"><font
										style="vertical-align: inherit;">WebTicket</font></font></span></a>
						</div>
							...
							<form action="UsuarioLogar" method="post">
								...
								<div class="checkbox">
									<label> <input type="checkbox"><font
										style="vertical-align: inherit;"><font
											style="vertical-align: inherit;">Lembre-me </font></font></label> <font
										style="vertical-align: inherit;"><label
										class="pull-right"><a href="#"><font
												style="vertical-align: inherit;">Esqueceu a senha?</font></a></label></font><label
										class="pull-right"> <a href="#"><font
